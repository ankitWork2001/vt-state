...
export default function EmptyState() {
  return (
    <div className="h-auto min-w-fit w-full max-w-[80%] mx-auto pt-10 flex justify-center items-center flex-col border-t border-slate-400">
      <div className="h-60 w-full max-w-90 bg-[#E9D5C9] border border-[#E9D5C9] flex justify-center items-center mb-6">
        <div className="w-35 h-[80%] bg-white text-[#E9D5C9] flex items-center justify-center"></div>
      </div>
