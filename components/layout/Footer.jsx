...
const Footer = () => {
  return (
    <footer className="bg-[#1F3C5F] text-white p-8 mt-12 mx-0">
      <div className="container mx-auto grid grid-cols-2 md:flex md:flex-row flex-wrap justify-evenly items-start gap-8 md:gap-12">
        <div>
